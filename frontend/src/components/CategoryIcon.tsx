...
const iconNameMap: Record<string, IconDef> = {
  briefcase: { path: 'M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2M12 12v.01' },
  'trending-up': { path: 'M23 6l-9.5 9.5-5-5L1 18M17 6h6v6' },
  'dollar-sign': { path: 'M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6' },
  'plus-circle': { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v8M8 12h8' },
  'arrow-up-circle': { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM16 12l-4-4m0 0l-4 4m4-4v8' },
  home: { path: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2zM9 22V12h6v10' },
  zap: { path: 'M13 2L3 14h9l-1 8 10-12h-9l1-8z' },
  'shopping-cart': { path: 'M9 20a1 1 0 100 2 1 1 0 000-2zm7 0a1 1 0 100 2 1 1 0 000-2zM1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6' },
  shirt: { path: 'M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18M16 10a4 4 0 01-8 0' },
  package: { path: 'M16.5 9.4l-9-5.19M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 002 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16zM3.27 6.96L12 12.01l8.73-5.05M12 22.08V12' },
  shield: { path: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' },
  'bar-chart-2': { path: 'M18 20V10M12 20V4M6 20v-6' },
  car: { path: 'M5 17h14v-5H5v5zm11.5-5L18 8H6l1.5 4M7 17a1 1 0 100 2 1 1 0 000-2zm10 0a1 1 0 100 2 1 1 0 000-2zM9 4h6' },
  ...
  utensils: { path: 'M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2M7 2v20M21 15V2v0a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zm0 0v7' },
  ...
  bus: { path: 'M7 17h10v-8H7v8zm4-8h2m3 0h2M6 8h1M5 17a1 1 0 100 2 1 1 0 000-2zm10 0a1 1 0 100 2 1 1 0 000-2zM5 4h14m-9 0v4' },
  plane: { path: 'M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z' },
  book: { path: 'M4 19.5A2.5 2.5 0 016.5 17H20M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z' },
  film: { path: 'M22 2H2v20h20V2zM10 2v20M2 12h20M6 2v20M18 2v20M14 2v20' },
  smile: { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01' },
  'shield-check': { path: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zM9 12l2 2 4-4' },
  gift: { path: 'M20 12v8H4v-8M22 8H2v4h20V8zM12 8v12M12 8c0-3-2-5-4-5S4 5 4 8m8 0c0-3 2-5 4-5s4 2 4 5' },
  ...
  smartphone: { path: 'M17 2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2V4a2 2 0 00-2-2zm0 18H7V4h10v16zM12 18h.01' },
  globe: { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z' },
  ...
  piggybank: { path: 'M19 5c-1.5 0-2.8.8-3.5 2H11a5 5 0 000 10h1M7 17l-1 3M15 7h4l2 3-2 3h-4M10 10.5V13M10 3v1M5 9H2m4 2L4 9m2-2L4 7' },
  gamepad: { path: 'M6 11h4M8 9v4m7-4h.01M18 10h.01M17.32 5H6.68a4 4 0 00-3.978 3.59C2.15 11.76 2 13.84 2 16a4 4 0 004 4h12a4 4 0 004-4c0-2.16-.15-4.24-.702-6.41A4 4 0 0017.32 5z' },
  ...
  baby: { path: 'M9 12h.01M15 12h.01M10 16c.5.8 1.3 1 2 1s1.5-.2 2-1M12 2a3 3 0 00-3 3v1H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V8a2 2 0 00-2-2h-3V5a3 3 0 00-3-3z' },
  ...
  clock: { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 6v6l4 2' },
  calendar: { path: 'M19 4H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2zM16 2v4M8 2v4M3 10h18' },
  'alert-circle': { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v4M12 16h.01' },
  'check-circle': { path: 'M22 11.08V12a10 10 0 11-5.93-9.14M22 4L12 14.01l-3-3' },
  target: { path: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 18a6 6 0 100-12 6 6 0 000 12zM12 14a2 2 0 100-4 2 2 0 000 4z' },
  ...
  trash: { path: 'M4 7h16M10 11v6M14 11v6M5 7l1 12a2 2 0 002 2h8a2 2 0 002-2l1-12M9 7V4a1 1 0 011-1h4a1 1 0 011 1v3' },
  'arrow-right': { path: 'M5 12h14M12 5l7 7-7 7' },
  wallet: { path: 'M21 12V7H5a2 2 0 010-4h14v4M3 5v14a2 2 0 002 2h16v-5M18 12a1 1 0 100 2 1 1 0 000-2z' },
  ...
  more: { path: 'M12 13a1 1 0 100-2 1 1 0 000 2zm-7 0a1 1 0 100-2 1 1 0 000 2zm14 0a1 1 0 100-2 1 1 0 000 2z' },
